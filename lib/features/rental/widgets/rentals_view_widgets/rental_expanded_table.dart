...
class RentalExpandedTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        buildDetailRow('PROPERTY TYPE', rental.propertyType, isDark: isDark),
        SizedBox(height: 8.h),
        ...
        SizedBox(height: 8.h),
        buildDetailRow('SHIPMENT', rental.shipment, isDark: isDark),
        SizedBox(height: 8.h),
        buildDetailRow('PAYMENT', rental.payment, isDark: isDark),
        SizedBox(height: 8.h),
        CustomPrimaryText(
          text: 'ACTION:',
          fontSize: 12.sp,
