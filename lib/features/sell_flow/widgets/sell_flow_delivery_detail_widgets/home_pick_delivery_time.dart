...
class HomePickDeliveryTime extends GetWidget<SellFlowDeliveryController> {
  const HomePickDeliveryTime({super.key});
        ...
        children: [
          ...
          ...List.generate(controller.timeIndex.length, (index) {
            return Padding(
              ...
              child: Column(
                children: List.generate(controller.timeSlots.length, (i) {
                  return Row(
                    children: [
                      CustomRadioButton(
                        value: i,
