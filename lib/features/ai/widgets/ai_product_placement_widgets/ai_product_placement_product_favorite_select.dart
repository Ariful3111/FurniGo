...
class AiProductPlacementProductFavoriteSelect
    extends GetWidget<AiProductPlacementController> {
  const AiProductPlacementProductFavoriteSelect({super.key});
        ...
        Obx(() {
          return SizedBox(
            ...
            child: ListView.builder(
              controller: controller.favoriteSelectedScrollController,
              scrollDirection: Axis.horizontal,
              itemCount: controller.favoriteSelectedItems.length,
