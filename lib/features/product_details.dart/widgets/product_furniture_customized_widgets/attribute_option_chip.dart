...
class AttributeOptionChip extends GetWidget<ProductAttributesController> {
      ...
      return GestureDetector(
        onTap: () {
          controller.toggleSelection(
            attributeID: option.productAttributeOptionId?.toInt() ?? 0,
          );
        },
        child: SharedContainer(
          ...
          border: Border.all(
            color:
                controller.selectedIDs.contains(
                  option.productAttributeOptionId?.toInt() ?? 0,
                )
                ? isDark
          ...
          child: Row(
            ...
            children: [
              ...
              if ((option.price ?? 0) > 0) ...[
                SizedBox(width: 6.w),
                CustomPrimaryText(
                  text: '+\$${(option.price ?? 0).toStringAsFixed(2)}',
                  fontSize: 12.sp,
                  color: isDark
